# 2025-03-19 11:20:20 by RouterOS 7.18.2
# software id = GZWT-77UD
#
# model = CCR1009-8G-1S
# serial number = 675005590B1C
/ip ipsec peer
add address=1.1.1.61/32 local-address=1.1.1.28 name=peer1
/ip pool
...
add peer=peer1
/ip ipsec policy
add dst-address=192.168.64.0/24 peer=peer1 src-address=172.18.28.0/25 tunnel=\
    yes
/ip service
