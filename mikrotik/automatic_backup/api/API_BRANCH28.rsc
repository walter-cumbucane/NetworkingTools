# jul/05/2025 10:28:57 by RouterOS 6.43.4
# software id = 8G2Q-WEY9
#
# model = CCR1016-12G
# serial number = 42D402D57E20
/interface bridge
add fast-forward=false name=bridge1
add name=lo
/interface ethernet
...
/ip pool
add name=dhcp_pool0 ranges=172.18.28.31-172.18.28.125
/ip dhcp-server
...
add disabled=true max-limit=6000000/6000000 name=queue2 target=ether2,ether2
/routing ospf area
...
add address=172.17.28.190/26 disabled=true interface=ether6 network=\
    172.17.28.128
add address=172.17.28.254/26 disabled=true interface=ether7 network=\
    172.17.28.192
add address=10.10.11.210/24 disabled=true interface=ether2 network=10.10.11.0
add address=10.20.12.28/24 disabled=true interface=ether2 network=10.20.12.0
/ip dhcp-server network
add address=172.18.28.0/25 dns-server=192.168.99.37 domain=adrmm.co.mz \
    gateway=172.18.28.126
/ip dns
...
/ip ipsec peer
add address=1.1.1.71/32 local-address=1.1.1.28 secret="\$2018\$"
add address=1.1.1.72/32 local-address=1.1.1.28 secret="\$2018\$"
/ip ipsec policy
add dst-address=1.1.1.71/32 sa-dst-address=1.1.1.71 sa-src-address=1.1.1.28 \
    src-address=1.1.1.28/32 tunnel=true
add disabled=true dst-address=1.1.1.72/32 sa-dst-address=1.1.1.72 \
    sa-src-address=1.1.1.28 src-address=1.1.1.28/32 tunnel=true
add disabled=true dst-address=192.168.64.0/24 sa-dst-address=1.1.1.71 \
    sa-src-address=1.1.1.28 src-address=172.18.28.0/25 tunnel=true
add dst-address=192.168.0.0/17 sa-dst-address=1.1.1.71 sa-src-address=\
    1.1.1.28 src-address=172.18.28.0/25 tunnel=true
add disabled=true dst-address=172.16.0.0/22 sa-dst-address=1.1.1.71 \
    sa-src-address=1.1.1.28 src-address=172.17.28.0/25 tunnel=true
/ip route
add distance=1 dst-address=172.16.0.0/22 gateway=10.20.10.61
/ip service
...
add area=area1 range=172.17.28.0/24
...
add area=area1 network=1.1.1.28/32
add area=area1 network=10.20.10.0/24
add area=area1 network=10.20.11.0/24
/routing rip
set distribute-default=if-installed redistribute-connected=true \
    redistribute-ospf=true
/routing rip neighbor
add address=10.20.12.10
/routing rip network
add network=10.20.12.0/24
add network=172.18.28.0/25
/snmp
