# jun/07/2024 11:54:38 by RouterOS 6.43.4
# software id = PUII-UKMK
#
# model = RouterBOARD 3011UiAS
# serial number = 8EED08A7F817
/interface bridge
add name=lo
/interface ethernet
set [ find default-name=ether1 ] comment=FO mac-address=CC:2D:E0:92:42:CB
...
/ip pool
add name=dhcp_pool0 ranges=172.18.9.31-172.18.9.125
/ip dhcp-server
...
add max-limit=4000000/0 name=queue3 target=172.17.9.32/32
add disabled=true max-limit=64000/64000 name=queue4 target=172.17.9.29/32
/routing ospf area
set [ find default=true ] disabled=true
add area-id=0.0.0.1 name=area1
/routing ospf instance
set [ find default=true ] redistribute-connected=as-type-1 router-id=1.1.1.9
...
/ip address
add address=10.20.11.9/24 interface=ether1 network=10.20.11.0
add address=172.18.9.126/25 interface=ether3 network=172.18.9.0
add address=1.1.1.9 interface=lo network=1.1.1.9
add address=172.17.9.190/26 disabled=true interface=ether6 network=\
    172.17.9.128
add address=172.17.9.254/26 disabled=true interface=ether7 network=\
    172.17.9.192
add address=10.10.11.210/24 disabled=true interface=ether1 network=10.10.11.0
add address=10.30.10.1/30 disabled=true interface=ether1 network=10.30.10.0
/ip dhcp-server network
add address=172.18.9.0/25 dns-server=192.168.99.37 domain=adrmm.co.mz \
    gateway=172.18.9.126
/ip dns
...
/ip ipsec peer
add address=1.1.1.72/32 local-address=1.1.1.9 secret="\$2018\$"
add address=1.1.1.71/32 local-address=1.1.1.9 secret="\$2018\$"
/ip ipsec policy
add dst-address=1.1.1.71/32 sa-dst-address=1.1.1.71 sa-src-address=1.1.1.9 \
    src-address=1.1.1.9/32 tunnel=true
add disabled=true dst-address=1.1.1.72/32 sa-dst-address=1.1.1.72 \
    sa-src-address=1.1.1.9 src-address=1.1.1.9/32 tunnel=true
add disabled=true dst-address=172.16.0.0/22 sa-dst-address=1.1.1.71 \
    sa-src-address=1.1.1.9 src-address=172.17.9.0/24 tunnel=true
add dst-address=192.168.0.0/17 sa-dst-address=1.1.1.71 sa-src-address=1.1.1.9 \
    src-address=172.18.9.0/25 tunnel=true
add disabled=true dst-address=192.168.0.0/18 sa-dst-address=1.1.1.71 \
    sa-src-address=1.1.1.9 src-address=172.17.9.0/25 tunnel=true
/ip service
...
add area=area1 range=172.17.9.0/24
...
add area=area1 network=1.1.1.9/32
