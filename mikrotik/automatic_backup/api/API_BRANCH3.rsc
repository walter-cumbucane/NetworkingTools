# jul/05/2025 10:27:50 by RouterOS 6.43.4
# software id = XIWI-CQTC
#
# model = RouterBOARD 3011UiAS
# serial number = 8EED08136ADC
/interface bridge
add name=lo
/interface ethernet
set [ find default-name=ether1 ] comment=FO mac-address=CC:2D:E0:8A:D3:76
...
/ip pool
add name=dhcp_pool0 ranges=172.18.3.31-172.18.3.125
/ip dhcp-server
...
/ip address
add address=10.20.10.3/24 interface=ether1 network=10.20.10.0
add address=172.18.3.126/25 interface=ether3 network=172.18.3.0
add address=1.1.1.3 interface=lo network=1.1.1.3
add address=172.17.3.190/26 interface=ether6 network=172.17.3.128
add address=172.17.3.254/26 interface=ether7 network=172.17.3.192
add address=10.10.11.210/24 disabled=true interface=ether2 network=10.10.11.0
add address=10.20.11.3/24 interface=ether2 network=10.20.11.0
/ip dhcp-server network
add address=172.18.3.0/25 dns-server=192.168.99.37 domain=adrmm.co.mz \
    gateway=172.18.3.126
/ip dns
...
/ip ipsec peer
add address=1.1.1.72/32 local-address=1.1.1.3 secret="\$2018\$"
add address=1.1.1.71/32 local-address=1.1.1.3 secret="\$2018\$"
/ip ipsec policy
add dst-address=1.1.1.71/32 sa-dst-address=1.1.1.71 sa-src-address=1.1.1.3 \
    src-address=1.1.1.3/32 tunnel=true
add disabled=true dst-address=1.1.1.72/32 sa-dst-address=1.1.1.72 \
    sa-src-address=1.1.1.3 src-address=1.1.1.3/32 tunnel=true
add disabled=true dst-address=172.16.0.0/22 sa-dst-address=1.1.1.71 \
    sa-src-address=1.1.1.3 src-address=172.17.3.0/24 tunnel=true
add disabled=true dst-address=192.168.0.0/18 sa-dst-address=1.1.1.71 \
    sa-src-address=1.1.1.3 src-address=172.17.3.0/25 tunnel=true
add dst-address=192.168.0.0/17 sa-dst-address=1.1.1.71 sa-src-address=1.1.1.3 \
    src-address=172.18.3.0/25 tunnel=true
/ip service
...
add area=area1 range=172.17.3.0/24
...
add authentication=md5 authentication-key="\$2018\$" interface=ether1 \
    network-type=nbma priority=0
add authentication=md5 authentication-key="\$2018\$" interface=ether9 \
    network-type=nbma priority=0
...
add area=area1 network=1.1.1.3/32
