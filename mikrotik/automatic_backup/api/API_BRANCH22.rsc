# jul/05/2025 10:28:38 by RouterOS 6.43.4
# software id = PU3E-MKNJ
#
# model = RouterBOARD 3011UiAS
# serial number = 8EEA08577655
/interface bridge
add fast-forward=false name=lo
/interface ethernet
...
set [ find default-name=ether10 ] poe-out=forced-on poe-priority=24
/interface list
add name=dicovery
...
/ip pool
add name=dhcp_pool0 ranges=172.18.22.21-172.18.22.125
/ip dhcp-server
add address-pool=dhcp_pool0 disabled=false interface=ether3 name=dhcp1
/queue simple
add max-limit=1000000/1000000 name=queue1 target=172.17.22.23/32
add disabled=true max-limit=1000000/1000000 name=queue2 target=ether2
add disabled=true max-limit=3000000/3000000 name=queue3 target=ether2
add disabled=true max-limit=1000000/1000000 name=queue5 target=\
    ether3,192.168.30.138/32
/routing ospf area
set [ find default=true ] disabled=true
add area-id=0.0.0.1 name=area1
/routing ospf instance
set [ find default=true ] redistribute-connected=as-type-1 redistribute-rip=\
    as-type-1 router-id=1.1.1.22
...
/ip address
add address=10.20.10.22/24 interface=ether1 network=10.20.10.0
add address=10.20.11.22/24 interface=ether2 network=10.20.11.0
add address=172.18.22.126/25 interface=ether3 network=172.18.22.0
add address=1.1.1.22 interface=lo network=1.1.1.22
add address=172.17.22.190/26 disabled=true interface=ether6 network=\
    172.17.22.128
add address=172.17.22.254/26 disabled=true interface=ether7 network=\
    172.17.22.192
add address=10.10.11.210/24 disabled=true interface=ether2 network=10.10.11.0
add address=10.20.13.22/24 disabled=true interface=ether2 network=10.20.13.0
/ip dhcp-server network
add address=172.18.22.0/25 dns-server=192.168.99.37 domain=adrmm.co.mz \
    gateway=172.18.22.126
/ip dns
...
/ip ipsec peer
add address=1.1.1.72/32 local-address=1.1.1.22 secret="\$2018\$"
add address=1.1.1.71/32 local-address=1.1.1.22 secret="\$2018\$"
/ip ipsec policy
add dst-address=1.1.1.71/32 sa-dst-address=1.1.1.71 sa-src-address=1.1.1.22 \
    src-address=1.1.1.22/32 tunnel=true
add disabled=true dst-address=1.1.1.72/32 sa-dst-address=1.1.1.72 \
    sa-src-address=1.1.1.22 src-address=1.1.1.22/32 tunnel=true
add disabled=true dst-address=172.16.0.0/22 sa-dst-address=1.1.1.71 \
    sa-src-address=1.1.1.22 src-address=172.17.22.0/24 tunnel=true
add dst-address=192.168.0.0/17 sa-dst-address=1.1.1.71 sa-src-address=\
    1.1.1.22 src-address=172.18.22.0/25 tunnel=true
add disabled=true dst-address=192.168.0.0/18 sa-dst-address=1.1.1.71 \
    sa-src-address=1.1.1.22 src-address=172.17.22.0/25 tunnel=true
/ip service
...
add area=area1 range=172.17.22.0/24
...
add area=area1 network=1.1.1.22/32
