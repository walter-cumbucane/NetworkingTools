# jul/05/2025 10:28:42 by RouterOS 6.43.4
# software id = BQJ9-K265
#
# model = RouterBOARD 3011UiAS
# serial number = 8EEA0867AF01
/interface bridge
add name=lo
/interface ethernet
...
/ip pool
add name=dhcp_pool0 ranges=172.18.23.31-172.18.23.125
/ip dhcp-server
...
/ip address
add address=10.20.10.23/24 interface=ether1 network=10.20.10.0
add address=10.20.11.23/24 interface=ether2 network=10.20.11.0
add address=172.17.23.126/25 disabled=true interface=ether3 network=\
    172.17.23.0
add address=1.1.1.23 interface=lo network=1.1.1.23
add address=172.17.23.190/26 disabled=true interface=ether6 network=\
    172.17.23.128
add address=172.17.23.254/26 disabled=true interface=ether7 network=\
    172.17.23.192
add address=10.10.11.210/24 disabled=true interface=ether2 network=10.10.11.0
add address=172.18.23.126/25 interface=ether3 network=172.18.23.0
/ip dhcp-server network
add address=172.18.23.0/25 dns-server=192.168.99.37 domain=adrmm.co.mz \
    gateway=172.18.23.126
/ip dns
...
/ip ipsec peer
add address=1.1.1.72/32 local-address=1.1.1.23 secret="\$2018\$"
add address=1.1.1.71/32 local-address=1.1.1.23 secret="\$2018\$"
/ip ipsec policy
add dst-address=1.1.1.71/32 sa-dst-address=1.1.1.71 sa-src-address=1.1.1.23 \
    src-address=1.1.1.23/32 tunnel=true
add disabled=true dst-address=1.1.1.72/32 sa-dst-address=1.1.1.72 \
    sa-src-address=1.1.1.23 src-address=1.1.1.23/32 tunnel=true
add disabled=true dst-address=172.16.0.0/22 sa-dst-address=1.1.1.71 \
    sa-src-address=1.1.1.23 src-address=172.17.23.0/24 tunnel=true
...
add dst-address=192.168.0.0/17 sa-dst-address=1.1.1.71 sa-src-address=\
    1.1.1.23 src-address=172.18.23.0/25 tunnel=true
add disabled=true dst-address=192.168.0.0/18 sa-dst-address=1.1.1.71 \
    sa-src-address=1.1.1.23 src-address=172.17.23.0/25 tunnel=true
/ip service
...
add area=area1 range=172.17.23.0/24
...
add area=area1 network=1.1.1.23/32
